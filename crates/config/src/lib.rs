...
pub use {
    loader::{
        ...
        config_dir, data_dir, discover_and_load, ensure_default_person_seeded,
        ensure_people_md_seeded, find_or_default_config_path, find_user_global_config_file,
        heartbeat_path, identity_path, is_valid_person_name, load_agents_md, load_heartbeat_md,
        load_identity, load_identity_md_raw, load_persona_agents_md, load_persona_identity,
        load_persona_identity_md_raw, load_persona_soul, load_persona_tools_md, load_soul,
        load_tools_md, load_user, people_dir, people_path, save_config, save_identity,
